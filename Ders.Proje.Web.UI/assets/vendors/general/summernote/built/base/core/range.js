    ...
    WrappedRange.prototype.normalize = function () {
        ...
        var getVisiblePoint = function (point, isLeftToRight) {
            ...
            if (dom_1["default"].isVisiblePoint(point)) {
                if (!dom_1["default"].isEdgePoint(point) ||
                    (dom_1["default"].isRightEdgePoint(point) && !isLeftToRight) ||
                    (dom_1["default"].isLeftEdgePoint(point) && isLeftToRight) ||
                    (dom_1["default"].isRightEdgePoint(point) && isLeftToRight && dom_1["default"].isVoid(point.node.nextSibling)) ||
                    (dom_1["default"].isLeftEdgePoint(point) && !isLeftToRight && dom_1["default"].isVoid(point.node.previousSibling)) ||
                    (dom_1["default"].isBlock(point.node) && dom_1["default"].isEmpty(point.node))) {
                    return point;
                }
            }
